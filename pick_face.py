...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier(r'E:\Pycharm\xrx-work\Facecard\others\haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
     readPicSaveFace('E:\cut-face','E:','.jpg','.JPG','png','PNG')
